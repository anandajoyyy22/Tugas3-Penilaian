...
from main.views import product_xml_by_id, product_json_by_id
...
urlpatterns = [
    ...
    path('products/<int:pk>/json/', product_json_by_id, name='product_json_by_id'),
    path('products/<int:pk>/xml/', product_xml_by_id, name='product_xml_by_id'),
